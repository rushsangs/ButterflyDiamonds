...
<body>
	...
	<div id="wrapper">
		...
		<div id="main">
			<!-- Begin Intro -->
			<div class="intro">
				<span class="intro-text">Considered extremely rare, the shades of blue diamonds share the powerful blue of the sea, the endless vastsky or a pale winter day.</span>
			</div>
			<!-- End Intro -->
			<div class="box">
				<div class="item-meta">
					<h1 class="entry-title">Blue Diamonds</h1>
					<div class="item-controls">
						<span class="prev"><a href="green.php" title="Previous"></a></span>
						<span class="up"><a href="coloureddiamonds.php" title="All Items"></a></span>
						<span class="next"><a href="yellow.php" title="Next"></a></span>
					</div>
				</div>
				<hr />
				
					<img class="paddingneeded" src="style/images/art/blue3.png" width="200px" style="float:right" alt="" />
					<p>The powerful color of the sea and the sky meet in these ex- ceptional gems. Blue diamonds are considered extremely rare and mysterious. They range from the light blue sky of a winters day to the deep blue of the ocean.</p>
					
					<img  class="paddingneeded" src="style/images/art/bluestone.jpg" width="200px" style="float:left" alt="" />
					<h5>BLUE ORIGIN</h5>
					<p>The Cullinan mine and Golconda region are the most notable areas where blue diamonds have come from. The most famous blue diamond in history is the 45 carat Hope Diamond. In 2008 The Wittelsbach Diamond, a 35.56 carat ushion-shaped fancy deep blue, was purchased at auction for $24 million. Experts compare this stones color and characteristics to the famed Hope Diamond.</p>
					<h5>COLOUR FORMATION</h5>
					<p>The vast majority of blue diamonds owe their color to the presence of boron. The bonding of boron to carbon causes absorption in the red, yellow and green parts of the spectrum producing a blue color. Blue Diamonds may contain a gray, violet or greenish modifying color. </p>
					...
					<img class="paddingneeded" src="style/images/art/bluegrid.jpg"  alt="" />
					<p>Source: NCDIA</p>
				</div>
				</div>
				<div class="clear"></div>
