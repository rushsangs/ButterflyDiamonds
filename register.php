...
<body>
	...
	<div id="wrapper">
        ...
        <form action="<?php echo esc_url($_SERVER['PHP_SELF']); ?>" class="forms"
                method="post" 
                name="registration_form" id='myform'>
                <fieldset>
                	<ol>
                		<h4>Personal details</h4>
                <li class="form-row text-input-row"> <label>First name</label>
                	<input type="text" name="firstname" class="text-input" style="width:40%"/>
                	<label style="right:49%">Last name</label> <input type="text" name="lastname" class="text-input" style="width:40%;display: inline-block"/>
                </li>
                
                <li class="form-row text-input-row">
                	<label>Company</label> <input type="text" name="company" class="text-input" style="width:40%"/>
                
                	<label style="right:46%">Contact number</label> <input type="text" name="contact" class="text-input" style="width:40%;display: inline-block"/>
                </li>
                <br>
                <h4>Log in details	</h6>
                <li class="form-row text-input-row">
                	<label>Username</label> <input type='text' 
                name='username' 
                id='username' class="text-input" style="width:40%"/>
                	<label style="right:52%">Email</label> <input type="text" name="email" id="email" class="text-input" style="width:40%;display: inline-block" /><br>
                </li>
                <li class="form-row text-input-row">
                	<label>Password</label> <input type="password"
                             name="password" 
                             id="password" class="text-input" style="width:40%"/>
                
                <label style="right:45%">Confirm password</label> <input type="password" 
                                     name="confirmpwd" 
                                     id="confirmpwd" class="text-input" style="width:40%;display: inline-block"/></li>
                                    </ol>
            <a href="#"  class="button dark" id="registerclick"
                   value="Register" 
                   onclick="return regformhash(document.getElementById('myform'),document.getElementById('username'),
                                 document.getElementById('email'),document.getElementById('password'),document.getElementById('confirmpwd'));" >Register</a>
        </fieldset>
        </form>
        <script>
