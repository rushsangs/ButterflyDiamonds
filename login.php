...
<body id="page">
	...
	<div id="wrapper">
        ...
        ?>
			...
			<?php else : ?>
				<form name="login_form" id="loginform" class="forms" method="post" action='includes/process_login.php'>
				<fieldset>
				<ol>
				<li class=" form-row text-input-row">	
					<label>Email</label>
				<input type="text" name="email" class="text-input" style="width:30%">
				</li>
				<li class=" form-row text-input-row">
				<label>Password</label>
				<input type="password" name="password" id="password" class="text-input" style="width:30%">
				</li>
				<a href="#" class="dark button" id="loginclick"
                   value="Login" 
                   onclick="formhash(document.getElementById('loginform'), document.getElementById('password'));" >Login </a>
				</ol>
				</fieldset>
				</form>
				<script>
