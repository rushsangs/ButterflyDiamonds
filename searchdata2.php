...
<body id="page">
	...
	<script type="text/x-kendo-template" id="template2">
                         ...
                         <div class="item">
          <div class="thumb">
          	<a href= #= PHOTO # class="hover fancybox-media"  title= #= PID # ><span class="overlay zoom"></span><img src= #= PHOTO #  style="display: inline" onerror="this.src='style/images/imgnotavailable.jpg'" width='280px'></a>
          </div>
          <div class="details">
