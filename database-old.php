...
<body id="page">
	...
	<div class="one-half last"><a onclick="defaul()" class="button dark">Send Email</a></div>
</div>
                ...
                <div id="tabstrip">
                    <div>
                        <div class='employee-details'>
                            <img src= #= PHOTO # class="innertab" width='300px'>
                            <table>
       ...
       <script>
		...
		source=new kendo.data.DataSource({
          ...
          // //  document.write("<p>"+item1.CTS+"</p>");
           ...
           {
           		var selecteddata="";
           		document.getElementById("test").innerHTML="<p>"+wholedata[0].SELECT.title+"</p>"
           		for(var i=0;i<wholedata.length;++i)
           		{
           			
           			if(wholedata.SELECT.checked==true)
           			{
